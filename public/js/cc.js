(function() {
    var ccJs = function(options) {
        var mode = "BCP";
        var bcpDomain = "",
            async_props = { async: false, asyncBehaviors: {}, asyncOpportunityIds: [], asyncOpportunities: [] },
            behaviors = {},
            urls = {},
            bcpd_callback = null,
            pv = "pv\x3dy",
        ...
        client = bcpClient = 10026;
        var firstPartyHost = "cc.ibm.com";
        var actualClient = {
            id: 10026,
            useFirstPartyDomain: "never",
            domainPrefix: "cc",
            cookieDomain: "ibm.com",
            cookieDomainIDN: "ibm.com"
        };
        var useFpcMatchesUserAgent = /^(?!.*chrome.*).*safari\/\d+.*/.test(navigator.userAgent.toLowerCase());
        ...
        function setTest(testOn) {
            if (typeof testOn !=
                "undefined" && (testOn == true || testOn == false)) test = testOn
        }
        ...
        function getDefinedValue(overrideVal, defaultVal) {
            if (typeof overrideVal != "undefined" &&
                overrideVal != null) return overrideVal;
        ...
        function baseURL(is_pv, version, domainArg, sepArg, delimArg) {
            ...
            var domainToUse;
            if (typeof domainArg !=
                "undefined" && domainArg != null) domainToUse = domainArg;
        ...
        namespace.runOptimus = "runOptimus" in options ? options.runOptimus :
            true;
        if (!client) return false;
        var addEvent = function() {
            if (document.addEventListener) return function(obj, sEvent, func) { obj.addEventListener(sEvent, func, false); return true };
            else if (document.attachEvent) return function(obj, sEvent, func) { obj.attachEvent("on" + sEvent, func); return true };
            else return function(obj, sEvent, func) { return false }
        }();
        ...
        function addBehavior(id) { add("b", id) }

        function addAction(id) { add("act", id) }

        function addInterest(id) { add("int", id) }

        function addMedia(id) { add("med", id) }

        function addMemberId(id) {}

        function addContentId(id) {}

        function addOpportunityId(id) { placementOpps.p.push(id) }

        function addOpportunity(tag) { placementOpps.pt.push(tag) }

        function appendInternal(url, vals, vr) { if (typeof vals != "undefined" && vals.length > 0) { var vn = delim + vr + "\x3d"; for (var i = 0; i < vals.length; i++) url += vn + vals[i] } return url }

        function appendAll(url) { for (var type in behaviors) url = appendInternal(url, behaviors[type], type); for (var pl_type in placementOpps) url = append(url, placementOpps[pl_type], pl_type); if (placementOpps.p.length > 0 || placementOpps.pt.length > 0) url = append(url, "y", "dp"); if (async_props.async) url = append(url, "y", "async"); return url }

        function getDomain() {
            if (useFirstPartyDomain) return "bcp." +
                (test ? "test." : "") + firstPartyHost;
            else return test ? "bcp.test.lotame.com" : "bcp.crwdcntrl.net"
        }
        ...
        function bcp() {
            if (client == "15" || /fotolog/i.test(domain)) {
                ...
                for (var i = 0; i < ints.length; i++)
                    if (decodeURIComponent(ints[i]).toLowerCase() == "country:us" || decodeURIComponent(ints[i]).toLowerCase() == "country:ca") foundUS = true;
                if (!foundUS) return
            }
            bcpinternal()
        }

        function bcpinternal() { namespace.loaded ? firebcp() : dobcp = true }
        ...
        function img_done(url) { if (bcpd_callback) bcpd_callback() }
        ...
        function firebcp() {
            ...
            if (namespace.runOptimus) try {
                addTrigger({
                    "int": ["digitalData : cm_mmca1 : {{html}}.ownerDocument.parentWindow.digitalData.util.qp.cm_mmca1"],
                    location: "(.*)",
                    element: "{{html}}.ownerDocument.parentWindow.digitalData.util.qp.cm_mmca1",
                    event: "",
                    opr: 77583
                });
                addTrigger({ "int": ["digitalData : cm_mmca1 : {{html}}.ownerDocument.defaultView.digitalData.util.qp.cm_mmca1"], location: "(.*)", element: "{{html}}.ownerDocument.defaultView.digitalData.util.qp.cm_mmca1", event: "", opr: 77584 });
                addTrigger({ "dem": ["digitalData : isIBMer : {{html}}.ownerDocument.parentWindow.digitalData.user.segment.isIBMer"], location: "(.*)", element: "{{html}}.ownerDocument.parentWindow.digitalData.user.segment.isIBMer", event: "", opr: 77287 });
                addTrigger({
                    "dem": ["digitalData : isIBMer : {{html}}.ownerDocument.defaultView.digitalData.user.segment.isIBMer"],
                    location: "(.*)",
                    element: "{{html}}.ownerDocument.defaultView.digitalData.user.segment.isIBMer",
                    event: "",
                    opr: 77294
                });
                addTrigger({ "genp": ["digitalData : gbt10 : {{html}}.ownerDocument.defaultView.digitalData.page.category.ibm.gbt10"], location: "(.*)", element: "{{html}}.ownerDocument.defaultView.digitalData.page.category.ibm.gbt10", opr: 77458 });
                addTrigger({
                    "genp": ["digitalData : gbt10 : {{html}}.ownerDocument.parentWindow.digitalData.page.category.ibm.gbt10"],
                    location: "(.*)",
                    element: "{{html}}.ownerDocument.parentWindow.digitalData.page.category.ibm.gbt10",
                    opr: 77459
                });
                addTrigger({ "genp": ["digitalData : gbt17 : {{html}}.ownerDocument.defaultView.digitalData.page.category.ibm.gbt17"], location: "(.*)", element: "{{html}}.ownerDocument.defaultView.digitalData.page.category.ibm.gbt17", opr: 77460 });
                addTrigger({ "genp": ["digitalData : gbt17 : {{html}}.ownerDocument.parentWindow.digitalData.page.category.ibm.gbt17"], location: "(.*)", element: "{{html}}.ownerDocument.parentWindow.digitalData.page.category.ibm.gbt17", opr: 77461 });
                addTrigger({
                    "genp": ["digitalData : gbt20 : {{html}}.ownerDocument.defaultView.digitalData.page.category.ibm.gbt20"],
                    location: "(.*)",
                    element: "{{html}}.ownerDocument.defaultView.digitalData.page.category.ibm.gbt20",
                    opr: 77462
                });
                addTrigger({ "genp": ["digitalData : gbt20 : {{html}}.ownerDocument.parentWindow.digitalData.page.category.ibm.gbt20"], location: "(.*)", element: "{{html}}.ownerDocument.parentWindow.digitalData.page.category.ibm.gbt20", opr: 77463 });
                addTrigger({
                    "genp": ["digitalData : gbt30 : {{html}}.ownerDocument.defaultView.digitalData.page.category.ibm.gbt30"],
                    location: "(.*)",
                    element: "{{html}}.ownerDocument.defaultView.digitalData.page.category.ibm.gbt30",
                    opr: 77464
                });
                addTrigger({ "genp": ["digitalData : gbt30 : {{html}}.ownerDocument.parentWindow.digitalData.page.category.ibm.gbt30"], location: "(.*)", element: "{{html}}.ownerDocument.parentWindow.digitalData.page.category.ibm.gbt30", opr: 77465 });
                addTrigger({ "dmn": ["digitalData : referrerDomain : {{html}}.ownerDocument.parentWindow.digitalData.page.pageInfo.referrerDomain"], location: "(.*)", element: "{{html}}.ownerDocument.parentWindow.digitalData.page.pageInfo.referrerDomain", event: "", opr: 77289 });
                addTrigger({
                    "dmn": ["digitalData : referrerDomain : {{html}}.ownerDocument.defaultView.digitalData.page.pageInfo.referrerDomain"],
                    location: "(.*)",
                    element: "{{html}}.ownerDocument.defaultView.digitalData.page.pageInfo.referrerDomain",
                    event: "",
                    opr: 77302
                });
                bindTriggers()
        ...
        function generateFirebcpURL(version) {
            ...
            if (typeof lotbcp != "undefined") url = append(url, lotbcp,
                "b");
        ...
        function loadAsync() {
            if (async_props.async) try {
                with(async_props) {
                    ...
                    for (var i = 0, tag; tag =
                        asyncOpportunities[i++];) addOpportunity(asyncOpportunities[tag])
                }
                bcp()
            } catch (e) {}
        }
        ...
        function bindTriggers() {
            placement_rules.sort(function(a, b) { var regex = /^#/; if (regex.test(a.element) && !regex.test(b.element)) return -1; if (!regex.test(a.element) && regex.test(b.element)) return 1; return 0 });
            ...
            if (OptimusRule.element_cache.length > 0)
                for (var i = OptimusRule.element_cache.length - 1; i >= 0; i--) {
                    ...
                    for (var ev in handlers) addEvent(el, ev, function(h) { var evt_el = el; return function(evt) { for (var j = 0, callback; callback = h[j++];) callback.call(evt_el, evt); var b_count = 0; for (var type in behaviors) b_count++; if (b_count > 0) bcpw() } }(handlers[ev]));
                    delete OptimusRule.element_cache[i];
                    OptimusRule.element_cache.length--
                }
        }

        function addOptimusRule(r) { var o = new OptimusRule(r); return o.process() }

        function addHapaxRule(r) { var h = new HapaxRule(r); return h.process() }

        function addPlacementRule(r) { placement_rules.push(new PlacementRule(r)) }
        ...
        OptimusRule.prototype = {
            process: function() {
                ...
                for (var href in this.document_map) {
                    if (this.document_map[href] ===
                        null) continue;
                    var loc_match = null;
                    try {
                        var re = new RegExp(this.location);
                        loc_match = re.exec(href)
                    } catch (e) { this.add("opterr", "location-match") }
            ...
            match: function(doc) {
                ...
                for (var i = 0, m; m = matches[i++];) p_behavior = p_behavior.replace(m.expression,
                    m.property_content !== null ? m.property_content : "");
            ...
            add: function(b) { add(this.behavior_type, b) },
            ...
            is_valid: function() {
                ...
                if (this.rule_id ===
                    null || isNaN(parseInt(this.rule_id))) valid = false;
            ...
            filter: function(c) { var str = c.replace(/\<\/?[^>]+\/?\>/gi, "").replace(/\n|\t|\r/gi, " ").replace(/\s{2,}/g, " ").replace(/\[quote\][\s\S]*\[\/quote\]/gi, ""); try { str = decodeURIComponent(str) } catch (e) {} if (typeof client !== "undefined" && client == 2241) str = str.replace(/[^\u0020-\u007e]/g, ""); return str },
            query: function(q, doc) {
                ...
                try {
                    ...
                    while ((results = this.query_regex.exec(q)) !== null) {
                        ...
                        if (els.length > 0) matches.push({ expression: expr, elements: els[0], property_name: property, property_content: els[1] })
                    }
                } catch (e) {
                    this.add("opterr",
            ...
            document_map: function(w, doc_map) {
                ...
                if (window.parent != w) {
                    try { if (w.parent.location.href) { has_access = true; return arguments.callee(w.parent, doc_map) } } catch (e) {}
                    if (!has_access)
        ...
        OptimusRule.supported_sources = {
            e: function(s,
                p, d) { var p = p || "value"; var els = this.query_by_selector(s, d); var props = []; for (var i = 0, e; e = els[i++];) { var prop_arr = p.split("."); for (var j = 0; typeof e[prop_arr[j]] !== "undefined"; j++) e = e[prop_arr[j]]; if (j === prop_arr.length) props.push(this.filter(e.toString())) } var p_content = props.length > 0 ? props.join(",") : null; return els.length > 0 ? [els, p_content] : [] },
            r: function(s, p, d) {
                var p = parseInt(p) || 0;
                var re = new RegExp(s);
                var matches = re.exec(d.referrer);
                var r_prop = matches !== null && typeof matches[p] !== "undefined" ? this.filter(matches[p]) :
                    null;
        ...
        HapaxRule.prototype.is_valid = function() {
            ...
            if (this.behavior ===
                "" || this.behavior === null || typeof this.behavior !== "object") valid = false;
            return valid
        };
        ...
        PlacementRule.prototype.addOpportunityId = function() { addOpportunityId(this.placement_id) };
        PlacementRule.prototype.addOpportunity = function() { addOpportunity(this.placement) };
        PlacementRule.prototype.is_valid = function() {
            ...
            if (this.element === "" || this.element === null || typeof this.element !==
                "string") valid = false;
            return valid
        };
        (function() {
            ...
            var arrayIt = function(a) {
                if (!!(window.attachEvent && !window.opera)) return function(a) { if (a instanceof Array) return a; for (var i = 0, result = [], m; m = a[i++];) result[result.length] = m; return result };
                else return function(a) { return Array.prototype.slice.call(a) }
            }();
            ...
            function filter(a, tag) {
                ...
                for (var i = 0, ae; ae = a[i++];) { ae.uid = ae.uid || _uid++; if (!uids[ae.uid] && (!tag || ae.nodeName.search(tag) !== -1)) r[r.length] = uids[ae.uid] = ae }
                return r
            }

            function getAttribute(e, a) { if (!e) return null; if (a === "class" || a === "className") return e.className; if (a === "for") return e.htmlFor; return e.getAttribute(a) || e[a] }

            function getByClass(selector, selectorRE, root, includeRoot, cacheKey,
                tag, flat) {
                var result = [];
                ...
                var es =
                    tag == "*" && root.all ? root.all : root.getElementsByTagName(tag);
            ...
            function getById(selector, root, includeRoot, cacheKey, tag, flat) {
                ...
                if (root.getElementById) rs = root.getElementById(selector);
                ...
                if (!!includeRoot) es[es.length] = root;
                for (var index = 0, e; e = es[index++];)
                    if (getAttribute(e, "id") === selector) { result[result.length] = e; break }
                return result
            }
            ...
            function getContextFromSequenceSelector(selector, roots, includeRoot, flat) {
                ...
                context =
                    reg.typeSelector.exec(selector)[1];
                ...
                if (reg.id.test(context)) {
                    ...
                    contextRE = persistCache[context + "RegExp"] || (persistCache[context + "RegExp"] = new RegExp("(?:^|\\s)" + context.replace(/\./g,
                        "\\s*") + "(?:\\s|$)"));
                ...
                while (rootCount > -1) {
                    ...
                    if (cacheOn && cache[cacheKey]) { result = result.concat(cache[cacheKey]); continue }
                    if (contextType === "id") tResult = getById(context, root, includeRoot, cacheKey, tag, flat);
                    else if (contextType === "class") tResult = getByClass(context, contextRE, root, includeRoot, cacheKey, tag, flat);
                    else {
                        tResult = arrayIt(root.getElementsByTagName(context));
                        if (!!includeRoot && (root.nodeName.toUpperCase() ===
                                context.toUpperCase() || context === "*")) tResult[tResult.length] = root
                    }
            ...
            peppy = {
                query: function(selectorGroups, root, includeRoot, recursed, flat) {
                    var elements = [];
                    if (!recursed) selectorGroups = selectorGroups.replace(reg.trim, "").replace(/(\[)\s+/g, "$1").replace(/\s+(\])/g, "$1").replace(/(\[[^\] ]+)\s+/g, "$1").replace(/\s+([^ \[]+\])/g, "$1").replace(/(\()\s+/g, "$1").replace(/(\+)([^0-9])/g, "$1 $2").replace(/['"]/g,
                        "").replace(/\(\s*even\s*\)/gi, "(2n)").replace(/\(\s*odd\s*\)/gi, "(2n+1)");
                    ...
                    if (reg.quickTest.test(selectorGroups)) { elements = getContextFromSequenceSelector(selectorGroups, root, includeRoot, flat); return cache[cacheKey] = elements.slice(0) }
                    var groupsWorker,
                        groups, selector, parts = [],
                        part;
                    ...
                    while ((selector = groups[gCount++]) !== undefined) {
                        ...
                        if (reg.quickTest.test(selector)) {
                            result = getContextFromSequenceSelector(selector,
                                root, includeRoot, flat);
                        ...
                        if (reg.combinatorTest.test(selector)) {
                            ...
                            while (pCount < pLength) {
                                ...
                                part1 = result || peppy.query(parts[pCount++], root, includeRoot, true,
                                    flat);
                ...
                queryCombinator: function(l, r, c) {
                    var result = [],
                        ...
                        fail = {},
                        combinatorCheck =
                        peppy.simpleSelector.combinator[c];
                ...
                simpleSelector: {
                    attribute: {
                        ...
                        "\x3d": function(e, a, v) { return getAttribute(e, a) == v },
                    ...
                    pseudos: {
                        ...
                        ":nth-last-child": function(e, n) { return this[":nth-child"](e, n) },
                        ":nth-of-type": function(e, n, t) { return this[":nth-child"](e, n, null, null, t) },
                        ":nth-last-of-type": function(e, n, t) { return this[":nth-child"](e, n, null, null, t) },
                        ...
                        ":first-of-type": function(e,
                            n, t) { return this[":nth-child"](e, "first", null, null, t) },
                        ...
                        ":not": function(e, s) {
                            return peppy.query(s, e, true, true, true).length ===
                                0
                        },
                        ...
                        ":header": function(e) {
                            return e.nodeName.search(/h\d/i) !==
                                -1
                        },
                    ...
                    combinator: {
                        ...
                        "\x3e": function(r, u, f, s) { return r.parentNode && u[r.parentNode.uid] },
                        "+": function(r, u, f, s) {
            ...
            if (doc.querySelectorAll)(function() {
                ...
                peppy.query = function(sel, context) {
                    context = context || doc;
                    if (context === doc) try { return context.querySelectorAll(sel) } catch (e) {}
        ...
        function makeJsonpCall(url, callbackMethod, delimArg) {
            var delimToUse = getDefinedValue(delimArg,
                delim);
            ...
            urlString = append(urlString, encodeURIComponent(delimToUse), "delim", delimToUse);
            ...
            if (fpcJsonArray.length > 0) {
                ...
                if (urlString.indexOf("fpc\x3dy") ==
                    -1) urlString = append(urlString, "y", "fpc", delimToUse)
            }
        ...
        function jsonpCallback(data) {
            ...
            removeJsonpTag(data);
            var firstPartyDomainScope;
            var returnedDomain = new String;
            if (data.domain && data.domain != "undefined" && data.domain != null) var firstPartyDomainScope = checkDomainScope();
            else firstPartyDomainScope =
                false;
            var delimToUse = getDefinedValue(data.delim, delim);
            if (firstPartyDomainScope)
                if (data.cookies && data.cookies != "undefined" && data.cookies != null && data.cookies.length > 0) writeCookies(data.cookies, returnedDomain);
            if (data.redirect) {
                var redirectUrl = new String(data.redirect);
                ...
                switch (redirectType) {
                    ...
                    default:
                        ...
                        var jsonPayload =
                            null;
                        if (redirectUrl.indexOf("ct\x3dy") != -1) { var isCookieable = false; if (firstPartyDomainScope) isCookieable = writeTestCookie(returnedDomain); if (isCookieable) redirectUrl = addFpcParam(redirectUrl) }
                        var url = addPortNumber(getPrefix() + getDomain());
                        url += redirectUrl;
                        if (typeof jsonPayload != "undefined" && jsonPayload != null) url = append(url, jsonPayload, "jsonpayload");
        ...
        function removeJsonpTag(data) {
            if (!data.callbackId || data.callbackId == "undefined" || data.callbackId ==
                null) return;
            var scriptTag = document.getElementById(data.callbackId);
            document.body.removeChild(scriptTag)
        }

        function removeCallbackParams(url, data, delimArg) { var delimToUse = getDefinedValue(delimArg, delim); if (data.callback != "undefined" && data.callback != null) url = removeUrlParam(url, delimToUse + "callback\x3d" + data.callback); if (data.callbackId) url = removeUrlParam(url, delimToUse + "callbackid\x3d" + data.callbackId); if (data.delim) url = removeUrlParam(url, delimToUse + "delim\x3d" + data.delim); return url }

        function removeUrlParam(url,
            param) { var array = url.split(param); return new String(array[0] + array[1]) }

        function getCookie(cookieName) { var cookieValue = null; var cookieString = new String(document.cookie); if (cookieString.length != 0) { var cookieMatch = cookieString.match(cookieName + "\x3d([^;]*)"); if (typeof cookieMatch != "undefined" && cookieMatch != null) cookieValue = cookieMatch[1] } return cookieValue }

        function getFirstPartyCookiesJson() {
            var retVal = new Array;
            var fpcId = getCookie(_cc_idCkeName);
            if (fpcId != null) retVal.push(createCookieJson(_cc_idCkeName,
                fpcId));
        ...
        function addFpcParam(url) { if (url.indexOf("fpc\x3dy") == -1) url = append(url, "y", "fpc"); return url }

        function createCookieJson(name, value) { return '{"name":"' + name + '","value":"' + value + '"}' }

        function createJsonPayload(cookies) {
            var jsonPayload = "{";
            if (cookies != null && typeof cookies == "object" &&
                cookies.length > 0) {
                var cookiesJson = new String('"cookies":[');
        ...
        function writeCookies(cookieArray, domainArg) {
            if (typeof cookieArray != "undefined" && cookieArray != null) {
                ...
                for (var i = 0; i < cookieCount; i++) {
                    ...
                    kvs["path"] = getCookiePropertyWithDefault(cookie,
                        "path", "/");
                    ...
                    var val;
                    for (var key in kvs) { val = kvs[key]; if (typeof val != "undefined" && val != null) cookieString += key + "\x3d" + val + ";" }
        ...
        function getCookiePropertyWithDefault(cookie, property, defaultVal) {
            if (cookie[property] !=
                "undefined" && cookie[property] != null) return cookie[property];
            else return defaultVal
        }

        function checkDomainScope() {
            if (actualClient.cookieDomain.length <= 0) return false;
            var domainCandidate = document.domain;
            if (actualClient.cookieDomain == "." + domainCandidate || actualClient.cookieDomain === domainCandidate || actualClient.cookieDomainIDN == "." + domainCandidate || actualClient.cookieDomainIDN === domainCandidate) return true;
            var index = domainCandidate.indexOf(actualClient.cookieDomain);
            if (index == -1) index = domainCandidate.indexOf(actualClient.cookieDomainIDN);
