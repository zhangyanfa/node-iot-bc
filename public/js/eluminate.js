// Licensed Materials - Property of IBM, eluminate.js (US Build # 4.18.138 Date/Time: 20160201-15:38), (C) Copyright IBM Corporation 2016. U.S. Government Users Restricted Rights:  Use, duplication or disclosure restricted by GSA ADP Schedule Contract with IBM Corp.
(function(c) {
    var i = "",
        h = "",
        b = false;
    ...
    c.cmOptedOut = function() {
        return ((i == "Y") || cI("CMDisabled") || e("CMOptout", "OPT_OUT") || e("CMOptOut", "OPT_OUT") || e("ID", "OPT_OUT"))
    };
    c.cmAnonymous = function() {
        return ((i == "A") || e("CMOptout", "ANONYMOUS") || e("CMOptOut", "ANONYMOUS"))
    };
...
function cmSetClientID(h, b, d, l, c) {
    ...
    if (!document.body && CM_DDX.headScripts) {
        ...
        document.write("<script src='./js/cp-v3.js'><\/script>")
    ...
    function i() {
        if ((typeof TLT !== "undefined") && (typeof TLT.getSessionData === "function")) {
...
function cmCreateProductviewTag(d, f, e, c, b) {
    var a = c1(cm_ClientID);
    cmMakeTag(["tid", "5", "pi", a ? a : "Product: " + f + " (" + d + ")", "pr", d, "pm", f, "cg", e, "pc", "N", "cm_vc", b ? b : cmExtractParameter("cm_vc", document.location.href), "cmAttributes", c])
}
var __sArray = [];
var __sRefArray = [];
var __sSkuArray = [];
...
function cmCalcSKUString() {
    ...
    function a(f, k, m, e, l, i, g, n) {
        if ((typeof(cm_currencyCode) == "undefined") || (!cm_currencyCode)) {
            cm_currencyCode = ""
        }
        l = l.toString().replace(cmPricePattern, "");
        k = k.toString().replace(cmSpacePattern, "");
        var h = c(g),
            d = c(n);
        return ["pr", k, "pm", m, "qt", e, "bp", l, "cg", i, "cmAttributes", g, "cmExtraFields", n, "ha1", cm_hex_sha1("" + (h ? h + "|||" : "") + (d ? "extra" + d : "")), "cc", cm_currencyCode, "at", f, "tid", "4", "pc", "N"]
    }
    b.cmCreateShopAction5Tag = function(g, i, f, k, h, e, d) {
        cmAddShop(a("5", g, i, f, k, h, e, d))
    };
    ...
    this.issue_page_element_tag = function(i) {
        ...
        if (k !== undefined) {
            if (k.indexOf("|" + i[0] + "~") == -1) {
                ...
                cmCreatePageElementTag(i[1], i[0] + "_" + IORequest.ab_group_number_source + "_" + IORequest.ab_group_number);
                IORequest.log(IORequest.log_trace, "issued page element source tag " + i[1], i[0] + "_" + IORequest.ab_group_number_source + "_" + IORequest.ab_group_number)
            } else {
                var h = k.split("|");
...
IORequest.set_and_check_cookie = function(d, a, b, c) {
    CB(d, a, b ? null : new Date(2020, 0).toGMTString(), c ? c : null);
